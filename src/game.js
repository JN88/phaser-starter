// This first two intergers are the dimensions of the game screen as x and y values.
// We are setting it to 640 pixels across, and 480 pixels down
// Note also that the 'gameDiv' parameter matches the div element defined in our index.html file
